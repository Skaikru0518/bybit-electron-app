...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-[calc(100vh-60px)] flex text-primary-text overflow-hidden">
      {/* Sidebar */}
      <div className="w-64 p-4 bg-sidebar-bg border-r border-sidebar-border text-sidebar-text shadow-lg flex flex-col overflow-hidden">
        <h2 className="text-lg font-semibold text-primary-text text-center mb-4">
          Bybit API Status
        </h2>
        <div
          className={`p-2 text-center rounded ${
            apiStatus === 'Connected ✅' ? 'bg-success' : 'bg-error'
          }`}
        >
          {apiStatus}
        </div>
