...
const Sidebar = ({ open, onToggle }) => {
	...
	return (
		<div
			className={cn(
				"flex flex-col bg-card border-r border-border transition-[width] duration-200 ease-in-out will-change-[width]",
				open ? "w-64" : "w-20"
			)}
		>
			...
			>
				<div className="space-y-2">
					<div className="flex-1 flex flex-col items-center">
						...
						{/* Account Info */}
						{open && (
							<div className="space-y-4 p-2 text-xs mt-4 w-full">
